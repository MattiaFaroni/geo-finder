...
import com.geocode.search.model.table.Settlement;
...
public class PolygonCoordinatesTest {
    ...
    public void testPolygonCoordinates() {
        ...
        Polygon polygon = polygonService.findGeoJson(PolygonController.levels.settlement, longitude, latitude);

        assertNotNull(polygon);

        assertEquals("[[44.72576, 9.28387], [44.72594, 9.28434], [44.7257, 9.28586], [44.7233, 9.28514], [44.72331, 9.28411], [44.7256, 9.28348], [44.72576, 9.28387]]", polygon.getCoordinates().get(0).get(0).toString());
